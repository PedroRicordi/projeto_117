...
function gotResults(error, results) {
    if(error) {
      ...
      img = document.getElementById('cachorro.webp')
      img1 = document.getElementById('gato.jpg')
      img2 = document.getElementById('boi.jpg')
      img3 = document.getElementById('leão.webp')
